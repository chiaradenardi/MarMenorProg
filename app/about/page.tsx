...
const About = () => {
    return (
        <div className="p-8">
            <h1 className="text-4xl font-bold mb-4">Storia del Mar Menor</h1>

            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/lagunaAlto.jpg" alt="Ecosistema del Mar Menor" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">Un ecosistema straordinario</h2>
            ...
            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/terreniLaguna.jpg" alt="Problemi ambientali" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">I problemi ambientali</h2>
                    <p className="text-base">
            ...
            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/pesciLaguna.jpg" alt="Crisi ambientale" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">Una crisi senza precedenti</h2>
                    <p className="text-base">
                    Tra il 2016 e il 2021, il Mar Menor ha vissuto momenti drammatici, con l'acqua che cambiava colore, assumendo una tonalità verdognola a causa dell’esplosione di alghe. Uno degli episodi più tragici si è verificato nell'agosto del 2021, quando ben cinque tonnellate di pesci e crostacei morti si sono riversati sulle rive della laguna. La vista degli animali senza vita, unita all'odore sgradevole della decomposizione e alla qualità dell'acqua fortemente compromessa, ha suscitato un'ondata di indignazione tra residenti e turisti, provocando la chiusura di numerose spiagge.
                    </p>
                </div>
            </div>

            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/proteste.jpg" alt="Tensioni e responsabilità" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">Le tensioni e le responsabilità</h2>
                    <p className="text-base">
            ...
            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/teresaVicente.jpg" alt="Personalità giuridica" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">Un passo storico: personalità giuridica</h2>
                    <p className="text-base">
            ...
            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/attivisti.jpg" alt="Iniziative di recupero" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">Iniziative di recupero</h2>
                    <p className="text-base">
                    Il governo spagnolo ha quindi stanziato quasi 500 milioni di euro per iniziative di recupero e protezione della laguna. Un comitato scientifico è stato incaricato di monitorare lo stato di salute del Mar Menor, con l’obiettivo di ristabilire, almeno in parte, il suo equilibrio ecologico.
                    </p>
                </div>
            </div>

            <div className="flex flex-col md:flex-row mb-8">
                <img src="images/litoraleLaguna.jpg" alt="Progetti attuali per il futuro" className="w-full md:w-1/3 mb-4 md:mb-0 md:mr-4"/>
                <div className="md:w-2/3">
                    <h2 className="text-2xl font-semibold mb-2">Progetti attuali per il futuro del Mar Menor</h2>
